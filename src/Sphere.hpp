...
public:
    ...
    bool intersect(const Ray& ray) {
        ...
        if (t0 < rejected) t0 = t1;
        if (t0 < rejected) return false;
        return true;
    }
    ...
    // TODO: https://blog.csdn.net/weixin_44518102/article/details/122698851
    Intersection getIntersection(Ray ray) {
        ...
        if (t0 < rejected) t0 = t1;
        if (t0 < rejected) return result;

        // if t0 is very close to 0, would reject the intersection
