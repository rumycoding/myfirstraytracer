...
// an issue if included in multiple cpp: https://github.com/Bly7/OBJ-Loader/issues/28
// need the inline keyword or separated the implementation into
// OBJ_Loader.cpp
// I will add the inline to all function implementation
